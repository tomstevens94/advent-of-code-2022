...
let xMin = Math.min(...rows.map(row => Math.min(...row.map(e => e[0])))); // Smallest X value
let yMin = Math.min(...rows.map(row => Math.min(...row.map(e => e[1])))); // Smallest Y value
let xMax = Math.max(...rows.map(row => Math.max(...row.map(e => e[0])))); // Largest X value
let yMax = Math.max(...rows.map(row => Math.max(...row.map(e => e[1])))); // Largest Y value
